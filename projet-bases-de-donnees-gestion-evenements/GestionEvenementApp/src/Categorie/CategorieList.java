...
public class CategorieList extends JFrame {
    ...
    public CategorieList() {
        ...
        String[] colonnes = { "ID", "Nom", "Description", "Public Cible", "Couleur" };
        ...
        refreshButton.addActionListener(e -> chargerCategories());
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                Object[] ligne = {
                        ...
                        rs.getString("couleur_affichage")
                };
